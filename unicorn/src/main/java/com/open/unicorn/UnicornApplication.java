		...
		public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
			http
				...
				.authorizeHttpRequests(auth -> auth
					...
					.requestMatchers("/", "/index.html", "/login.html", "/register.html", "/dashboard.html", "/uws-s3.html", "/uws-compute.html", "/uws-lambda.html", "/uws-rdb.html", "/uws-sqs.html", "/uws-secrets.html", "/uws-ai.html", "/css/**", "/js/**", "/images/**").permitAll()
